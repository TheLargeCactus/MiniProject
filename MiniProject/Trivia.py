...
questions = [
    ...
    Question("Why is Mercury’s magnetic field so weak? ", "Because it has a very thin atmosphere", "Because it has a very thick atmosphere","Because it orbits so quickly","Because Mercury is very small"),
